...
function products_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $separateDV = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	if($selected_id) {
		if(!check_record_permission('products', $selected_id, 'view'))
			return $Translation['tableAccessDenied'];

		// can edit?
		$AllowUpdate = check_record_permission('products', $selected_id, 'edit');

		// can delete?
		$AllowDelete = check_record_permission('products', $selected_id, 'delete');
