...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->ColWidth = [75, 150, 200, 150, 100, 150, 150, 150, 150, ];
	$x->ColCaption = ['Order ID', 'Status', 'Customer', 'Employee', 'Order Date', 'Shipped Date', 'Ship Via', 'Ship Country', 'Total', ];
	$x->ColFieldName = ['OrderID', 'Status', 'CustomerID', 'EmployeeID', 'OrderDate', 'ShippedDate', 'ShipVia', 'ShipCountry', 'Total', ];
	$x->ColNumber  = [1, 2, 3, 4, 5, 8, 9, 16, 19, ];
